...
Partial Public Class IMLSDCCDataContext
  ...
  #End Region
	...
	Public Function cTQWith1Facet(<Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal phrase As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal queryType As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal top_n As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal collectionID As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal portalCode As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal facetIn As String) As IQueryable(Of cTQWith1FacetResult)
	...
	Public Function cTQWith2Facet(<Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal phrase As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal queryType As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal top_n As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal collectionID As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal portalCode As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal facetIn As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal facetIn2 As String) As IQueryable(Of cTQWith2FacetResult)
	...
	Public Function cTQWith3Facet(<Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal phrase As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal queryType As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal top_n As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal collectionID As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal portalCode As System.Nullable(Of Integer), <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal facetIn As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal facetIn2 As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal facetIn3 As String) As IQueryable(Of cTQWith3FacetResult)
	...
	Public Function GetStats(<Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(5)")> ByVal portalCode As String) As ISingleResult(Of GetStatsResult)
		Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo), portalCode)
    ...
    Public Function GetItemsWithFacets(<Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal phrase As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal queryType As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal top_n As System.Nullable(Of Integer)) As IMultipleResults
    ...
    <Global.System.Data.Linq.Mapping.FunctionAttribute(Name:="dbo.GetCollectionsWithFacets"), _
    ResultType(GetType(collCTQResult)), _
    ResultType(GetType(FacetsWithRecords))> _
    Public Function GetCollectionsWithFacets(<Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal phrase As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="NVarChar(255)")> ByVal queryType As String, <Global.System.Data.Linq.Mapping.ParameterAttribute(DbType:="Int")> ByVal top_n As System.Nullable(Of Integer)) As IMultipleResults
        Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod, MethodInfo), phrase, queryType, top_n)
        Return CType(result.ReturnValue, IMultipleResults)
    End Function
End Class
...
Partial Public Class RecordsToDateBrowse
	...
	Private _datePivotRow As Integer
    ...
    Partial Private Sub OnCreated()
    End Sub
    Partial Private Sub OndatePivotRowChanging(value As Integer)
    End Sub
    Partial Private Sub OndatePivotRowChanged()
    End Sub
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_datePivotRow", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true)>  _
	Public Property datePivotRow() As Integer
		Get
			Return Me._datePivotRow
		End Get
		Set
			If ((Me._datePivotRow = value)  _
						= false) Then
				Me.OndatePivotRowChanging(value)
				Me.SendPropertyChanging
				Me._datePivotRow = value
				Me.SendPropertyChanged("datePivotRow")
				Me.OndatePivotRowChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_dateID", DbType:="Int NOT NULL")>  _
...
Partial Public Class RecordsToTitleBrowse
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Record_RecordsToTitleBrowse", Storage:="_Record", ThisKey:="recordID", OtherKey:="recordID", IsForeignKey:=true, DeleteOnNull:=true, DeleteRule:="CASCADE")>  _
	Public Property Record() As Record
		Get
			Return Me._Record.Entity
		End Get
		Set
			...
			If ((Object.Equals(previousValue, value) = false)  _
				...
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._Record.Entity = Nothing
					previousValue.RecordsToTitleBrowses.Remove(Me)
				End If
				Me._Record.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.RecordsToTitleBrowses.Add(Me)
					Me._recordID = value.recordID
				Else
					Me._recordID = CType(Nothing, Integer)
				End If
...
Partial Public Class Record
	...
	Private _firstCreator As String
	...
	Private _facetXML As System.Xml.Linq.XElement
	...
	Private _parent_XMLBlob As System.Xml.Linq.XElement
	
	Private _grandp_description As String
	
	Private _grandp_XMLBlob As System.Xml.Linq.XElement
	
	Private _portalCode As System.Nullable(Of Integer)
	
	Private _titleShort As String
	
	Private _datefromXML As String
	
	Private _RecordsToSubjects As EntitySet(Of RecordsToSubject)
	
	Private _RecordsToDateBrowses As EntitySet(Of RecordsToDateBrowse)
	
	Private _RecordsToTitleBrowses As EntitySet(Of RecordsToTitleBrowse)
    ...
    End Sub
    Partial Private Sub OnfirstCreatorChanging(value As String)
    End Sub
    Partial Private Sub OnfirstCreatorChanged()
    End Sub
    ...
    End Sub
    Partial Private Sub OnfacetXMLChanging(value As System.Xml.Linq.XElement)
    End Sub
    Partial Private Sub OnfacetXMLChanged()
    End Sub
    ...
    End Sub
    Partial Private Sub Onparent_XMLBlobChanging(value As System.Xml.Linq.XElement)
    End Sub
    Partial Private Sub Onparent_XMLBlobChanged()
    End Sub
    Partial Private Sub Ongrandp_descriptionChanging(value As String)
    End Sub
    Partial Private Sub Ongrandp_descriptionChanged()
    End Sub
    Partial Private Sub Ongrandp_XMLBlobChanging(value As System.Xml.Linq.XElement)
    End Sub
    Partial Private Sub Ongrandp_XMLBlobChanged()
    End Sub
    Partial Private Sub OnportalCodeChanging(value As System.Nullable(Of Integer))
    End Sub
    Partial Private Sub OnportalCodeChanged()
    End Sub
    Partial Private Sub OntitleShortChanging(value As String)
    End Sub
    Partial Private Sub OntitleShortChanged()
    End Sub
    Partial Private Sub OndatefromXMLChanging(value As String)
    End Sub
    Partial Private Sub OndatefromXMLChanged()
    End Sub
    #End Region
	...
	Public Sub New()
		...
		Me._RecordsToTitleBrowses = New EntitySet(Of RecordsToTitleBrowse)(AddressOf Me.attach_RecordsToTitleBrowses, AddressOf Me.detach_RecordsToTitleBrowses)
		Me._RecordsToFacets = New EntitySet(Of RecordsToFacet)(AddressOf Me.attach_RecordsToFacets, AddressOf Me.detach_RecordsToFacets)
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_firstCreator", DbType:="NVarChar(250)")>  _
	Public Property firstCreator() As String
		Get
			Return Me._firstCreator
		End Get
		Set
			If (String.Equals(Me._firstCreator, value) = false) Then
				Me.OnfirstCreatorChanging(value)
				Me.SendPropertyChanging
				Me._firstCreator = value
				Me.SendPropertyChanged("firstCreator")
				Me.OnfirstCreatorChanged
			End If
		End Set
	End Property
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_facetXML", DbType:="Xml", UpdateCheck:=UpdateCheck.Never)>  _
	Public Property facetXML() As System.Xml.Linq.XElement
		Get
			Return Me._facetXML
		End Get
		Set
			If (Object.Equals(Me._facetXML, value) = false) Then
				Me.OnfacetXMLChanging(value)
				Me.SendPropertyChanging
				Me._facetXML = value
				Me.SendPropertyChanged("facetXML")
				Me.OnfacetXMLChanged
			End If
		End Set
	End Property
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_titleText", DbType:="NVarChar(3000)")>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_titleNoPunct", DbType:="NVarChar(3000)")>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_parent_XMLBlob", DbType:="Xml", UpdateCheck:=UpdateCheck.Never)>  _
	Public Property parent_XMLBlob() As System.Xml.Linq.XElement
		Get
			Return Me._parent_XMLBlob
		End Get
		Set
			If (Object.Equals(Me._parent_XMLBlob, value) = false) Then
				Me.Onparent_XMLBlobChanging(value)
				Me.SendPropertyChanging
				Me._parent_XMLBlob = value
				Me.SendPropertyChanged("parent_XMLBlob")
				Me.Onparent_XMLBlobChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_grandp_description", DbType:="NVarChar(MAX)")>  _
	Public Property grandp_description() As String
		Get
			Return Me._grandp_description
		End Get
		Set
			If (String.Equals(Me._grandp_description, value) = false) Then
				Me.Ongrandp_descriptionChanging(value)
				Me.SendPropertyChanging
				Me._grandp_description = value
				Me.SendPropertyChanged("grandp_description")
				Me.Ongrandp_descriptionChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_grandp_XMLBlob", DbType:="Xml", UpdateCheck:=UpdateCheck.Never)>  _
	Public Property grandp_XMLBlob() As System.Xml.Linq.XElement
		Get
			Return Me._grandp_XMLBlob
		End Get
		Set
			If (Object.Equals(Me._grandp_XMLBlob, value) = false) Then
				Me.Ongrandp_XMLBlobChanging(value)
				Me.SendPropertyChanging
				Me._grandp_XMLBlob = value
				Me.SendPropertyChanged("grandp_XMLBlob")
				Me.Ongrandp_XMLBlobChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_portalCode", DbType:="Int")>  _
	Public Property portalCode() As System.Nullable(Of Integer)
		Get
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_titleShort", DbType:="NVarChar(200)")>  _
	Public Property titleShort() As String
		Get
			Return Me._titleShort
		End Get
		Set
			If (String.Equals(Me._titleShort, value) = false) Then
				Me.OntitleShortChanging(value)
				Me.SendPropertyChanging
				Me._titleShort = value
				Me.SendPropertyChanged("titleShort")
				Me.OntitleShortChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_datefromXML", DbType:="NVarChar(100)")>  _
	Public Property datefromXML() As String
		Get
			Return Me._datefromXML
		End Get
		Set
			If (String.Equals(Me._datefromXML, value) = false) Then
				Me.OndatefromXMLChanging(value)
				Me.SendPropertyChanging
				Me._datefromXML = value
				Me.SendPropertyChanged("datefromXML")
				Me.OndatefromXMLChanged
			End If
		End Set
	End Property
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Record_RecordsToTitleBrowse", Storage:="_RecordsToTitleBrowses", ThisKey:="recordID", OtherKey:="recordID")>  _
	Public Property RecordsToTitleBrowses() As EntitySet(Of RecordsToTitleBrowse)
		Get
			Return Me._RecordsToTitleBrowses
		End Get
		Set
			Me._RecordsToTitleBrowses.Assign(value)
		End Set
	End Property
	...
	Private Sub attach_RecordsToTitleBrowses(ByVal entity As RecordsToTitleBrowse)
		Me.SendPropertyChanging
		entity.Record = Me
	End Sub
	
	Private Sub detach_RecordsToTitleBrowses(ByVal entity As RecordsToTitleBrowse)
		Me.SendPropertyChanging
		entity.Record = Nothing
	End Sub
...
Partial Public Class GetItemsWithFacetsResult
...
Partial Public Class GetCollectionsWithFacetsResult
