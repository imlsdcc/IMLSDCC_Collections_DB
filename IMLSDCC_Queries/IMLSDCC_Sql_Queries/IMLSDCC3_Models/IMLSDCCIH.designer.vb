...
#Region "Extensibility Method Definitions"
    ...
    End Sub
    Partial Private Sub InsertCollectionProperty(ByVal instance As CollectionProperty)
    End Sub
    Partial Private Sub UpdateCollectionProperty(ByVal instance As CollectionProperty)
    End Sub
    Partial Private Sub DeleteCollectionProperty(ByVal instance As CollectionProperty)
    End Sub
    Partial Private Sub InsertInstitutionProperty(ByVal instance As InstitutionProperty)
    End Sub
    Partial Private Sub UpdateInstitutionProperty(ByVal instance As InstitutionProperty)
    End Sub
    Partial Private Sub DeleteInstitutionProperty(ByVal instance As InstitutionProperty)
    End Sub
    Partial Private Sub InsertCollection(ByVal instance As Collection)
    End Sub
    Partial Private Sub UpdateCollection(ByVal instance As Collection)
    End Sub
    Partial Private Sub DeleteCollection(ByVal instance As Collection)
    End Sub
    Partial Private Sub InsertCollectionInstitution(ByVal instance As CollectionInstitution)
    End Sub
    Partial Private Sub UpdateCollectionInstitution(ByVal instance As CollectionInstitution)
    End Sub
    Partial Private Sub DeleteCollectionInstitution(ByVal instance As CollectionInstitution)
    End Sub
    Partial Private Sub InsertInstitution(ByVal instance As Institution)
    End Sub
    Partial Private Sub UpdateInstitution(ByVal instance As Institution)
    End Sub
    Partial Private Sub DeleteInstitution(ByVal instance As Institution)
    End Sub
    Partial Private Sub InsertControlledVocabulary(ByVal instance As ControlledVocabulary)
    End Sub
    Partial Private Sub UpdateControlledVocabulary(ByVal instance As ControlledVocabulary)
    End Sub
    Partial Private Sub DeleteControlledVocabulary(ByVal instance As ControlledVocabulary)
    End Sub
#End Region

    Public Sub New()
        MyBase.New(Global.System.Configuration.ConfigurationManager.ConnectionStrings("Registry_ConnectionString").ConnectionString, mappingSource)
        OnCreated()
    End Sub
